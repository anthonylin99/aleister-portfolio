  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full flex items-center justify-center text-slate-400 hover:text-white transition-all shadow-lg border border-white/10 hover:border-violet-500/50"
        style={{ 
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div 
            className="relative p-6 rounded-2xl w-full max-w-sm border border-white/10"
            style={{ 
              background: 'linear-gradient(135deg, rgba(15,15,35,0.95) 0%, rgba(10,10,25,0.95) 100%)',
